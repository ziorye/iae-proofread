...
class BlockControllerTest extends WithMockUserForAdminBaseTest {
    ...
    void update() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.put("/backend/blocks/update")
                        .contentType(MediaType.APPLICATION_FORM_URLENCODED)
    ...
    void destroy() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.delete("/backend/blocks/destroy/" + block.getId()))
                .andExpect(MockMvcResultMatchers.redirectedUrl("/backend/collections/edit/" + collection.getId()))
        ;
